...
var creado=document.querySelector("#createdBy");
creado.innerHTML+=" Neider Urbano";
...
function buildToDo(todo, index) {
  ...
  if(todo.complete){
    toDoText.classList.add("compleText")
...
function buildToDos(toDos) {
  // Tu código acá:
  var toDo=[]
    toDos.map(function(informacionToDos,index) {
      toDo.push(buildToDo(informacionToDos,index))
    })
  return toDo;
}
...
//   // Tu código acá:
  ...
  buildToDos(toDoItems).forEach((valorToDo)=>{;
    toDoContainer.appendChild(valorToDo)
  })
}


// La función 'addToDo' agregará un nuevo ToDo al array 'toDoItems'
// [NOTA: Algunas cuestiones a tener en cuenta sobre el elemento 'input' 
//   de HTML (Ya que 'toDoInput' es un input)
// Todos los elementos input tienen una propiedad llamada 'value' que nos 
// permite acceder al texto que se encuentre
